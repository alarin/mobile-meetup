...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Partner.comment'
        db.add_column('conference_partner', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Partner.comment'
        db.delete_column('conference_partner', 'comment')
