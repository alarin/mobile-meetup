...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lecture.is_disabled'
        db.add_column('conference_lecture', 'is_disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lecture.is_disabled'
        db.delete_column('conference_lecture', 'is_disabled')
